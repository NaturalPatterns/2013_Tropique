...
# or on OS X
# 
#DYLD_LIBRARY_PATH="/usr/local/lib/fakenect/" FAKENECT_PATH="/Users/lup/Desktop/Tropique/dumps/fakenect/smoke_tunnel4" ./segmentation.py
#DYLD_LIBRARY_PATH="/usr/local/lib/fakenect/" FAKENECT_PATH="/Users/lup/Desktop/Tropique/dumps/lolo-brume" ./segmentation.py

#DYLD_LIBRARY_PATH="/usr/local/lib/fakenect/" FAKENECT_PATH="$1" $2
LD_LIBRARY_PATH="/usr/local/lib64646464646464646464646464646464646464646464646464646464646464646464646464646464646464646464646464646464646464646464646464646464/fakenect/" FAKENECT_PATH="$1" $2
